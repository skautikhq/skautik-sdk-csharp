...
namespace Skautik.Sdk.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public Configuration()
        {
            ...
            BasePath = "https://api.skautik.com/v1/api";
            ...
            {
                {
                    "AccountAndStatusApi.GetHealth", new List<IReadOnlyDictionary<string, object>>
                    {
                        {
                            new Dictionary<string, object>
                            {
        ...
        public Configuration(
            ...
            string basePath = "https://api.skautik.com/v1/api") : this()
        {
        ...
        {
            string report = "C# SDK (Skautik.Sdk) Debug Report:\n";
